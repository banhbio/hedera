...
def process_hmm_results(contig_list, hmm_file, hallmarks_list, scoredict, bin_id):
...
def main():
    ...
    parser.add_argument('-t', '--hmm', required=True, type=str, help='Path to the hmmsearch results file (tblout)')
    parser.add_argument('-o', '--total_output', required=True, type=str, help='Path to the output (total count) TSV file')
    parser.add_argument('-O', '--contigs_output', required=True, type=str, help='Path to the output (count per contigs) TSV file')
    parser.add_argument('-n', '--nhallmark', required=True, type=str, help='Comma-separated list of NCLDV hallmark genes')
    parser.add_argument('-s', '--score', required=True, type=str, help='Comma-separated list of score thresholds for each NCLDV hallmark gene')
    ...
    df_total, df_contigs = process_hmm_results(contig_list, args.hmm, hallmarks_list, scoredict, args.bin_id)
